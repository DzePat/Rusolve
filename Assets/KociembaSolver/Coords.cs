...
namespace TwoPhaseSolver
{
    ...
    public static class MoveTables
    {
        ...
        public static readonly ushort[,] moveCO = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\co_move");
        public static readonly ushort[,] moveEO = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\eo_move");
        public static readonly ushort[,] moveUD = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\ud_move");

        public static readonly ushort[,] moveCP = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\cp_move");
        public static readonly ushort[,] moveEP2 = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\ep2_move");
        public static readonly ushort[,] moveUDS = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\uds_move");

        public static readonly ushort[,] moveUS = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\us_move");
        public static readonly ushort[,] moveDS = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\move\\ds_move");

        // Merge table (US-DS to EP2), size 11880 * 24 = 285120

        public static readonly ushort[,] mergeEP2 = BinLoad.loadShortTable2D("Assets\\KociembaSolver\\tables\\other\\ep2_merge", 24);
    }
}
